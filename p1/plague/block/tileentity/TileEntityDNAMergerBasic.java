...
import p1.plague.block.BlockDNAMergerBasic;
import p1.plague.block.BlockSyringeScannerBasic;
import p1.plague.pathogen.NeedToBeFixedByP1;
import p1.plague.recipe.DNAMergerRecipes;
import cpw.mods.fml.common.registry.GameRegistry;

public class TileEntityDNAMergerBasic extends TileEntity implements IInventory,
		IPowered {
	...
	public void updateEntity() {
		...
		if (!worldObj.isRemote) {
			if (this.power < this.maxPower
					&& this.getItemPower(this.slots[3]) > 0) {
		...
		if (flag != (power > 0)) {
			flag1 = true;
			BlockDNAMergerBasic.updateFurnaceBlockState(this.power > 0,
	...
	private boolean canSmelt() {
		...
		ItemStack itemstack = DNAMergerRecipes.getSmeltingResult(
				slots[0].getItem().itemID, slots[1].getItem().itemID);
