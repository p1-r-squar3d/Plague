...
import p1.plague.item.metadata.ItemBloodSyringeAdvanced;
import p1.plague.item.metadata.ItemBloodSyringeBasic;
import p1.plague.item.metadata.ItemCircuitParts;
import p1.plague.item.metadata.ItemRubber;
...
public class PlagueItems {
	...
	public static String[] UN = { "syringeBasic", "uvScannerBasic", "blockirusDep", "syringeAdv", "uvScannerAdv", "blockirusDepAdv", "cylinder", "testTube", "dropper", "glassStrip", "glassPanel", "syringePlunger", "syringeNeedle", "syringeTube" };
