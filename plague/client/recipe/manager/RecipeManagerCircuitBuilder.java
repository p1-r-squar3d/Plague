package plague.client.recipe.manager;
...
import plague.client.recipe.sorter.RecipeSorterCircuitBuilder;
...
public class RecipeManagerCircuitBuilder
{
private static final RecipeManagerCircuitBuilder instance = new RecipeManagerCircuitBuilder();

private List recipes = new ArrayList();

public static final RecipeManagerCircuitBuilder getInstance()
{
return instance;
}

private RecipeManagerCircuitBuilder()
{
...
Collections.sort(this.recipes, new RecipeSorterCircuitBuilder(this));

System.out.println(this.recipes.size() + " recipes");
}
/**
 * Adds a shaped recipe hencing case sensitive slots.
 * @param par1ItemStack
 * @param par2ArrayOfObj
 * @return
 */
public CircuitBuilderShapedRecipes addShapedRecipe(ItemStack par1ItemStack, Object ... par2ArrayOfObj)
{
String var3 = "";
int var4 = 0;
int var5 = 0;
...
CircuitBuilderShapedRecipes var17 = new CircuitBuilderShapedRecipes(var5, var6, var15, par1ItemStack);
this.recipes.add(var17);
return var17;
}

/**
 * Adds a shapeless recipe hencing the overriding of any slots.
 * @param par1ItemStack
 * @param par2ArrayOfObj
 */
...
this.recipes.add(new CircuitBuilderShapelessRecipes(par1ItemStack, var3));
}
