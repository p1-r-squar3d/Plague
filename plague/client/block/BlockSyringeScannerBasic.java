...
import cpw.mods.fml.relauncher.SideOnly;
	...
	public class BlockSyringeScannerBasic extends BlockContainer{
		...
		public BlockSyringeScannerBasic(int id, boolean isActive) {
		...
		public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
		{
			...
			if (par0)
			{
				par1World.setBlock(par2, par3, par4, PlagueBlocks.blockSyringeScannerBasicActive.blockID);
			}
			else
			{
				par1World.setBlock(par2, par3, par4, PlagueBlocks.blockSyringeScannerBasicIdle.blockID);
			}
